...
graph <- function (filepath, x_labs, y_labs){
  ALT <- read_xpt(filepath) %>%
    filter(PARAMCD=="ALT")
  ...
  plot4 <- 
    ...
    geom_point(data = ALT3, aes(color = "red")) + 
    labs(x = x_labs,
         y = y_labs)
...
graph("https://github.com/phuse-org/phuse-scripts/raw/master/data/adam/cdisc/adlbc.xpt", "Alanine Aminotransferase U/L", "Week")
```

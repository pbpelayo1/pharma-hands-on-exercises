...
#creating a minimal dataset for reprex
rows <- sample(1:nrow(BICARB), size = 5, replace = FALSE)
BICARB2 <- BICARB %>% select(ADY, AVAL) %>% slice(rows)


#codes for reprex
library(tidyverse)

BICARB_sample <- tribble(
  ~ADY, ~AVAL,
  114, 0.04,
  188, 0.03,
  174, 0.04,
